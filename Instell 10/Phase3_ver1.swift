...
var phase3_ver1 = [ //“”
    Story(dday: "D-85", id: "ver1_3-1-1", nextId: "ver1_3-1-1-1", text: "", action: .text, gif: "ver1_3-1-1.gif", sound: "가을소리"),
    Story(imageName: "ver1_3-1-1", dday: "D-85", id: "ver1_3-1-1-1", nextId: "ver1_3-1-2", text: "여느 때와 같은 버스 안 등교길이었다.\nA: “뭐했다고 벌써 가을이네....”", action: .text),
    Story(imageName: "ver1_3-1-2", dday: "D-85", title: "친구", id: "ver1_3-1-2", nextId: "ver1_3-1-2-1", text: "“야 A야 같이가!”\nA: “잠깐만~ 나 채좀 챙기고”", action: .text),
    Story(dday: "D-85", id: "ver1_3-1-2-1", nextId: "ver1_3-2-1", text: "", action: .text, gif: "ver1_3-1-2"),
    ...
    Story(imageName: "ver1_3-2-4", dday: "D-75", title: "동아리원1", id: "ver1_3-2-4", nextId: "ver1_3-2-5", text: "“A야 아까 애들이랑 얘기해봤는데, 3학년 이번에 다 대회 나간데. 너도 같이 나갈 꺼지?”\n\nA는 배드민턴에 나름의 애정을 가지고 있었다. 고등학교 마지막 대회였다.", action: .text),
    Story(imageName: "ver1_3-2-5", dday: "D-75", title: "나", id: "ver1_3-2-5", nextId: "ver1_3-3-1", text: "“응 당연하지!”\n\nA는 살짝 웃으며 말했다.", action: .text),
    Story(imageName: "ver1_3-3-1", dday: "D-70", title: "학년부장", id: "ver1_3-3-1", nextId: "ver1_3-3-2", text: "“어 A야 저녁 맛있게 먹었니?”\n\n'아 안녕하세요 선생님'", action: .text),
    Story(imageName: "ver1_3-3-2", dday: "D-70", id: "ver1_3-3-2", nextId: "ver1_3-3-3", text: "운영위원장 사건 이후 학년부장은 이것 저것에서 A를 챙겨줬다. 입시 정보나 생기부 기록 등에서 A는 꽤 많은 도움을 받고 있었다.", action: .text),
    Story(imageName: "ver1_3-3-3", dday: "D-70", title: "학년부장", id: "ver1_3-3-3", nextId: "ver1_3-3-4", text: "“손에 그건... 아 배드민턴채구나. 맞다 A야 교무실에 배드민턴 대회 참가 공문이 와 있더라. 수능이 코 앞이라 우리 학교는 참여 안 하기로 했다.”", action: .text),
    Story(imageName: "ver1_3-3-4", dday: "D-70", title: "나", id: "ver1_3-3-4", nextId: "ver1_3-4-1", text: "“네...?”\n\nA가 미쳐 반응하기도 전에, 학년부장은 A를 지나쳐 갔다.", action: .text, gif: "ver1_3-3-4"),
    Story(imageName: "ver1_3-4-1", dday: "D-69", title: "동아리원1", id: "ver1_3-4-1", nextId: "ver1_3-4-1-1", text: "“야, 야 A야 소식 들었어….?”", action: .text, sound: "웅성거림"),
    Story(imageName: "ver1_3-4-1", dday: "D-69", title: "동아리원2", id: "ver1_3-4-1-1", nextId: "ver1_3-4-2", text: "“아니 오바지, 이미 준비 다 하고 있었는데 이걸 막는다고?”", action: .text),
    Story(imageName: "ver1_3-4-2", dday: "D-69", title: "동아리원1", id: "ver1_3-4-2", nextId: "ver1_3-4-3", text: "“저기 A야. 너 학년부장이랑 친하잖아. 어떻게 잘 말해보면 안 돼?”\n\n다른 아이들의 시선이 A에게로 쏠렸다. 시선은 기대감으로 차 있었다.", action: .text),
    ...
    Story(imageName: "ver1_3-4-4", dday: "D-69", id: "ver1_3-4-4", nextId: "ver1_3-4-5", text: "그러나 어렵게 얻은 학년부장과의 신뢰다. 심지어 어제 직접 얘기까지 들은 상태에서 맘대로 나간다고 했다간, 말 그대로 관계는 끝이었다.", action: .text),
    Story(id: "ver1_3-4-5", action: .choice, question: "어떻게 해야할까?", choices: ["학교에서 그렇다는 데 어쩌겠어...... 그리고 학년부장 말이 맞긴 하잖아. 수능이 코앞인데 대회 준비하면 시간 엄청 쓸꺼고. 그냥 이번만 쉬자.": "ver1_3-4-5-out1", "응 맞아 어떻게 준비한 건데 이렇게 끝내면 안 되지.": "ver1_3-4-6"]),
    Story(imageName: "ver1_3-4-5-out1", dday: "D-69", title: "동아리원2", id: "ver1_3-4-5-out1", nextId: "ver1_3-4-5-out2", text: "“야 너 그러기야?”", action: .text),
    Story(imageName: "ver1_3-4-5-out2", dday: "D-69", title: "동아리원1", id: "ver1_3-4-5-out2", nextId: "suneung", text: "“그렇게 생각할 수도 있지…. 일단 알겠어 A야…”", action: .text),
    Story(imageName: "ver1_3-4-6", dday: "D-69", title: "동아리원2", id: "ver1_3-4-6", nextId: "ver1_3-4-7", text: "“그럼 그럼! 근데 학교에서 막는데 우리 어쩌지?”", action: .text),
    ...
    Story(imageName: "ver1_3-5-3", dday: "D-68", title: "지현", id: "ver1_3-5-3", nextId: "ver1_3-5-4", text: "“과학부 이번에 R&D 대회 나가잖아. 그거 준비중이지.”", action: .text),
    ...
    Story(imageName: "ver1_3-5-6", dday: "D-68", title: "지현", id: "ver1_3-5-6", nextId: "ver1_3-5-6-1", text: "“과학부 애들중에는 수시 쓰는 애들이 많아서 학년부장이 그냥 조용히 준비하고 상 타오라고 했다던데? 우리 동아리 담당쌤이.”", action: .text),
    Story(dday: "D-68", id: "ver1_3-5-6-1", nextId: "ver1_3-6-1", action: .text, gif: "ver1_3-5-6-1"),
    Story(imageName: "ver1_3-6-1", dday: "D-67", title: "나", id: "ver1_3-6-1", nextId: "ver1_3-6-1-1", text: "다음 날, A는 교무실 상담실을 찾아가 학년부장에게 상담을 요청했다.", action: .text, gif: "ver1_3-6-1"),
    Story(imageName: "ver1_3-6-2", dday: "D-67", title: "나", id: "ver1_3-6-1-1", nextId: "ver1_3-6-2", text: "“선생님, 저희 배드민턴부 말인데요...”", action: .text),
