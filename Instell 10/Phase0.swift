...
var phase0 = [
    ...
    Story(imageName: "0-8", dday: "D-240", id: "0-8", nextId: "0-9", text: "다른 사람을 신경 쓰지 않고 자신의 공부만 잘하면 되는 것이 입시라고 생각하는 완벽주의자 A는\n고등학교 3학년이 된 후 이렇게 새벽까지 공부를 하다가 잠들곤 한다.", action: .text),
    Story(imageName: "0-9", dday: "D-240", id: "0-9", nextId: "0-10", text: "아침에 일어나서 학교에 가고, 학교에서 공부를 하고, 끝나고 학원을 가고, 학원이 끝나면 집에 와서 다시 공부를 하는 것.\n계속 이렇게 하다보면 원하는 대학에 합격할 수 있을 것이라고 굳게 믿는다.", action: .text, gif: "0-9"),
    ...
    Story(imageName: "0-14", dday: "D-240", title: "담임선생님", id: "0-14", nextId: "0-15", text: "“알다시피 우리 학교가 일반 고등학교 중에서는 상위권 대학들 잘 보낸 편이고, 그래서 3학년 때 잘만 하면 원하는 대학에 갈 수 있을 거야.\nA는 수능보다는 수시에 비중을 둘 생각이니?”", action: .text),
    ...
    Story(imageName: "0-16", dday: "D-240", title: "담임선생님", id: "0-16", nextId: "0-17", text: "“그래. 쌤도 그렇게 생각한다. 생활기록부도 스펙 같은 게 부족하지 않고 좋은데 되도록 3학년 때도 교내 대회 같은 거 나가서 수상 좀 추가하면 좋을 것 같네.\n이번 영어토론대회도 나갈 생각이니?”", action: .text),
