...
var phase3_ver2 = [ //“”
    ...
    Story(imageName: "ver2_3-2-6", dday: "D-75", title: "담임선생님", id: "ver2_3-2-6", nextId: "ver2_3-3-1", text: "“공부 잘하는 애들도 분명히 가르쳐주면서 더 배우고 이해하는 게 있을 거라고 생각한다. 멘토 멘티 표 붙여 놓을 테니까 오늘부터 시작하자.”", action: .text),
    Story(imageName: "ver2_3-3-1", dday: "D-70", title: "나", id: "ver2_3-3-1", nextId: "ver2_3-3-1-1", text: "“야, 어제 로그함수 이 문제 풀어 오기로 했잖아. 그래야 같이 비교해보면서 배우지”", action: .text, gif: "ver2_3-3-1"),
    ...
    Story(imageName: "ver2_3-4-1", dday: "D-69", id: "ver2_3-4-1", nextId: "ver2_3-4-2", text: "다음 날, 고민하던 A는 복도에서 생각에 잠겨 있었다. 반대쪽 품 안에 모의고사 문제집을 가득 쌓고 지나가는 지현이를 발견했다.", action: .text),
    ...
    Story(imageName: "ver2_3-4-10", dday: "D-69", title: "나", id: "ver2_3-4-10", nextId: "ver2_3-5-1", text: "“너가 멘토제 안 해봐서 그래. 부탁 좀 할게”", action: .text),
