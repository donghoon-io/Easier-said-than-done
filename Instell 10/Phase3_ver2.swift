...
var phase3_ver2 = [ //“”
    Story(imageName: "ver2_3-1-1", dday: "D-85", id: "ver2_3-1-1", nextId: "ver2_3-1-1-1", text: "", action: .text, gif: "ver2_3-1-1", sound: "가을소리"),
    Story(imageName: "ver2_3-1-1", dday: "D-85", id: "ver2_3-1-1-1", nextId: "ver2_3-1-2", text: "여느 때와 같은 버스 안 등교길이었다.\nA: “뭐했다고 벌써 가을이네....”", action: .text),
    Story(imageName: "ver2_3-1-1", dday: "D-85", title: "친구", id: "ver2_3-1-2", nextId: "ver2_3-1-2-1", text: "“야 A야 같이가!”\nA: “잠깐만~ 나 채좀 챙기고”", action: .text),
    Story(imageName: "ver2_3-1-1", dday: "D-85", id: "ver2_3-1-2-1", nextId: "ver2_3-2-1", text: "", action: .text, gif: "ver2_3-1-2"),
    ...
    Story(imageName: "ver2_3-2-4", dday: "D-75", id: "ver2_3-2-4", nextId: "ver2_3-2-4-1", text: "석식 시간이었다.", action: .text),
    Story(imageName: "ver2_3-2-4", dday: "D-75", title: "담임선생님", id: "ver2_3-2-4-1", nextId: "ver2_3-2-5", text: "“얘들아 나는 요즘 너희가 열심히 해 주는 것 같아 기쁘다. 그런데, 나는 너희 중 공부 잘 하는 몇몇이 아니라, 우리 반 전체가 다 잘 되었으면 한다.”", action: .text),
    Story(imageName: "ver2_3-2-5", dday: "D-75", title: "담임선생님", id: "ver2_3-2-5", nextId: "ver2_3-2-6", text: "“그래서 말인데, 오늘부터는 야자 첫 시간에 멘토 멘티제를 운영하려고 한다. 공부 잘 하는 애들이랑 조금 부족한 애들이랑 붙어서 도와줄거야.”", action: .text),
    Story(imageName: "ver2_3-2-6", dday: "D-75", title: "담임선생님", id: "ver2_3-2-6", nextId: "ver2_3-2-6-1", text: "“공부 잘하는 애들도 분명히 가르쳐주면서 더 배우고 이해하는 게 있을 거라고 생각한다. 멘토 멘티 표 붙여 놓을 테니까 오늘부터 시작하자.”", action: .text),
    Story(dday: "D-75", title: "", id: "ver2_3-2-6-1", nextId: "ver2_3-3-1", action: .text, gif: "ver2_3-2-6-1"),
    
    Story(imageName: "ver2_3-3-1", dday: "D-70", title: "", id: "ver2_3-3-1", nextId: "ver2_3-3-1-0", action: .text, gif: "ver2_3-3-1"),
    Story(imageName: "ver2_3-3-1", dday: "D-70", title: "나", id: "ver2_3-3-1-0", nextId: "ver2_3-3-1-1", text: "“야, 어제 로그함수 이 문제 풀어 오기로 했잖아. 그래야 같이 비교해보면서 배우지”", action: .text),
    Story(imageName: "ver2_3-3-1", dday: "D-70", title: "주아", id: "ver2_3-3-1-1", nextId: "ver2_3-3-2", text: "“아니 잘 안 풀리는 걸 어떻게 해. 그러지 말고 우리 그냥 어제처럼 영어하자. 응?”", action: .text),
    ...
    Story(dday: "D-70", id: "ver2_3-3-6", action: .choice, question: "어떻게 해야할까?", choices: ["결심한 건 당당하게 말하는 게 나아. 당장 교무실 가서 멘토 멘티 시간 낭비라 못하겠다고 말씀드리자": "ver2_3-3-6-out1", "그래도 그냥 싫다고 하면 엄청 실망하시겠지..? 방법을 찾아보자.": "ver2_3-4-1"]),
    ...
    Story(imageName: "ver2_3-4-3", dday: "D-69", title: "지현", id: "ver2_3-4-3", nextId: "ver2_3-4-4", text: "“요즘 학년부장이 전교 20등 이상인 애들 야자 교실 말고 면학실에서 하라잖아. 그거 말씀드리니까 담임쌤이 빼주시던데?”", action: .text),
    Story(imageName: "ver2_3-4-4", dday: "D-69", title: "지현", id: "ver2_3-4-4", nextId: "ver2_3-4-5", text: "“너한테는 학년부장이 아무 말 안 했어? 아 운영위원장 사건 이후로 너랑 껄끄러워서 터치 안 하나?”", action: .text),
    Story(imageName: "ver2_3-4-5", dday: "D-69", id: "ver2_3-4-5", nextId: "ver2_3-4-6", text: "A는 잠시 말이 없었다.", action: .text),
    Story(imageName: "ver2_3-4-6", dday: "D-69", title: "나", id: "ver2_3-4-6", nextId: "ver2_3-4-7", text: "“야 지현아 나 부탁 하나만 하자.”", action: .text),
    Story(imageName: "ver2_3-4-7", dday: "D-69", title: "지현", id: "ver2_3-4-7", nextId: "ver2_3-4-8", text: "“뭔데?? 일단 들어보고~”", action: .text),
    Story(imageName: "ver2_3-4-8", dday: "D-69", title: "나", id: "ver2_3-4-8", nextId: "ver2_3-4-9", text: "“학년부장한테, 왜 A는 안 옮기냐고, 불공평하다고 한마디만 해주면 안돼?”", action: .text),
    Story(imageName: "ver2_3-4-9", dday: "D-69", title: "지현", id: "ver2_3-4-9", nextId: "ver2_3-4-10", text: "“뭐 그 정도야 되는데, 이사 귀찮아. 왜 일부러 옮기려고 그러냐?”", action: .text),
    Story(imageName: "ver2_3-4-10", dday: "D-69", title: "나", id: "ver2_3-4-10", nextId: "ver2_3-4-10-1", text: "“너가 멘토제 안 해봐서 그래. 부탁 좀 할게”", action: .text),
    Story(dday: "D-69", title: "나", id: "ver2_3-4-10-1", nextId: "ver2_3-5-1", action: .text, gif: "ver2_3-4-10-1"),
